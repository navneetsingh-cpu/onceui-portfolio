---
title: 'A Full Stack E commerce store built in NextJs'
publishedAt: '2024-04-08'
summary: 'Development of a full-stack e-commerce store with a flexible and highly customizable design system using Next.js for the front end and Tailwind for seamless design collaboration.'
images:
...
link:
  - 'https://avi-ethnic-wear.vercel.app/'
team:
  - name: 'Navneet'
